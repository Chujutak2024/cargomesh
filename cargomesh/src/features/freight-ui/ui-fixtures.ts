...
export function createFreightIntakeFixture(reference = new Date()): FreightIntakeModel {
  const schedule = createFr1042DemoSchedule(reference);
  return {
    ...
    operatorMemberId: "e0000000-0000-0000-0000-000000000001",
    ...
    pickupContactName: "María Paredes",
    pickupContactPhone: "+51 999 210 440",
    pickupContact: "María Paredes · +51 999 210 440",
    receiverName: "Tomás Rojas",
    receiverCompany: "",
    receiverPhone: "+56 9 6123 4010",
    deliveryContact: "Tomás Rojas · +56 9 6123 4010",
    borderCrossing: "Santa Rosa / Chacalluta",
    operationalNotes: "Fixture de regresión visual; no representa una solicitud cargada desde el servidor.",
    cargoCategory: "Repuestos mineros",
    cargoCategoryId: "c0000000-0000-0000-0000-000000000005",
    cargoCategoryCode: "MACHINERY",
    cargoDescription: "Repuestos mineros",
    transportMode: "ROAD",
    serviceType: "FTL",
    entryMethod: "PALLETS",
    quantity: 10,
    ...
    recommendationValues: {
      origin_country: "PE",
      origin_city: "Lima",
      origin_address: "Callao",
      pickup_contact_name: "María Paredes",
      pickup_contact_phone: "+51 999 210 440",
      destination_country: "CL",
      destination_city: "Santiago",
      receiver_name: "Tomás Rojas",
      receiver_phone: "+56 9 6123 4010",
      ...
      entry_width_cm: 100,
      entry_height_cm: 150,
      pickup_mode: schedule.pickupMode,
      pickup_window_start: schedule.pickupWindowStart,
      pickup_window_end: schedule.pickupWindowEnd,
      delivery_deadline: schedule.deliveryDeadline,
      budget_max: 2000,
      optimization_strategy: "BALANCED",
      available_documents: ["Factura comercial", "Packing list"],
      cross_border: true,
    },
  };
}

export function createNewDraftIntakeModel(): FreightIntakeModel {
  return {
    source: "new-draft",
    freightRequestId: "",
    draftVersion: 0,
...
export function createCanonicalFreightRequestDraftModel(
  reference = new Date(),
): FreightIntakeModel {
  const fixture = createFreightIntakeFixture(reference);
  return {
    ...fixture,
    source: "new-draft",
    freightRequestId: "",
    ...
    originRegion: "Callao",
    originCity: "Callao",
    originAddress: "Terminal Portuario del Callao",
    origin: "Callao, PE",
    operationalNotes: "Escenario canónico FR-1042 para evaluación del jurado.",
    recommendationValues: {},
  };
}
