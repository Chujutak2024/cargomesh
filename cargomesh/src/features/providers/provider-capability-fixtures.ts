...
const providerCapabilityFixtures: Record<string, ProviderCapabilityFixture> = {
  "ANDES-PECL-FTL": {
    ...
    destination: {
      regionAliases: ["santiago", "valparaiso"],
      countryAliases: ["chile", "cl"],
    },
    cargoCategories: [
      "machinery", "mining spare parts", "maquinaria", "repuestos mineros",
      "general", "carga general",
      "agricultural", "agricola", "perecibles",
      "construction", "construccion", "materiales de construccion",
    ],
