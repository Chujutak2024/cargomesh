...
export function mapFreightRequestIntakeToForm(
  ...
  return {
    ...
    originCountry: intake.route.originCountry,
    originRegion: intake.route.originRegion ?? "",
    originCity: intake.route.originCity,
    originAddress: intake.route.originAddress ?? "",
    origin: intake.route.origin,
    destinationCountry: intake.route.destinationCountry,
    destinationRegion: intake.route.destinationRegion ?? "",
    destinationCity: intake.route.destinationCity,
    destinationAddress: intake.route.destinationAddress ?? "",
    ...
    cargoDescription: intake.cargo.description ?? "",
    ...
    requiresRefrigeration: intake.cargo.requiresRefrigeration,
    temperatureMinC: intake.cargo.temperatureMinC,
    temperatureMaxC: intake.cargo.temperatureMaxC,
    isHazardous: intake.cargo.isHazardous,
    isOversized: intake.cargo.isOversized,
    isFragile: intake.cargo.isFragile,
    ...
    draftVersion: intake.draftVersion,
