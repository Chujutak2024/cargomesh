...
> **Plan intermedio archivado.** La frase "adaptación que no reemplaza" y el flujo WebMCP/Andes de este documento no definen CargoMesh V2. Véanse [alcance vigente](../v2-amazon/contracts/PRODUCT_SCOPE.md), [Alexa/MCP](../v2-amazon/contracts/ALEXA_MCP_AWS.md) y [ruta semanal](../v2-amazon/delivery/SPRINT_ROADMAP.md). No presentar el guion objetivo como demo ya ejecutada.
