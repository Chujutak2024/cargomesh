...
**Actualización tras PR #83/#85 y rebase de Sprint 2:** esta auditoría fue escrita sobre una rama previa al merge. Ambos PR ya están en `codex/v2-amazon-contracts`. HAC-21 entregó sedes/áreas/lanes ROAD y cerró; **no** entregó `mcp_account_links` ni create/submit V2. Las menciones de «esperando HAC-21» de abajo se leen como capacidades pendientes, no como reapertura de HAC-21: `mcp_account_links` y la consulta MCP V2 están asignados a Axel en HAC-11; la elegibilidad/capacidad ROAD compartida corresponde a HAC-12. Create/submit V2 y Alexa+ live no se presumen incluidos en esas issues. La rama Gate-1 prepara la corrección de etiquetas del catálogo, sin habilitar esas capacidades.
...
- persistencia `mcp_account_links` y consulta MCP V2 asignadas a HAC-11; elegibilidad/capacidad ROAD asignada a HAC-12; otros servicios FreightRequest V2 requieren alcance explícito;
