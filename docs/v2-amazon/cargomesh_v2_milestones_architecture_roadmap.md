...
| HITO 1 · Datos, UI y prototipo **a corregir en Linear** | Sprint 1 · 19–25 sep (Lima) | Mapping/esquema V2 ROAD y RLS; MCP con límite seguro para Alexa+, prueba Bedrock opcional/condicionada; estandarización de botones, inputs, modals y tokens con prototipo navegable; decisión Google Maps/alternativa y mapa piloto; escenario QA y gate. HAC-17/18 aportan créditos/evidencia. Alexa live, Bedrock live y mapa externo se declaran solo con prueba real. |
...
2. **HITO 1:** el ciclo termina el 25 en Lima, no el 26 como día laborable adicional. Reescribir el propósito para cubrir **los cinco frentes de Sprint 1**: Cristhian mapea/implementa BD y flujo; Axel asegura transporte/identidad MCP y prueba Bedrock condicionada; Jean Paul construye QA y escenario ROAD; Luis estandariza botones/inputs/modals/tokens y prototipa; Juan compara Google Maps/alternativa e integra un mapa piloto. Gate-1 verifica integración. Quitar «160 tests» fijo y la afirmación de que dorado `#d2a95f` es requisito del jurado. No exigir stepper conectado ni mapa multimodal live esta semana. Actualizar su lista de ramas desde el manifiesto de las issues aprobadas.
