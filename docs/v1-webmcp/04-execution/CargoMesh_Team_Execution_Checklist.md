...
5. README.md
6. docs/v1-webmcp/00-master/ADR-001_Dynamic_Provider_Registry.md
7. docs/v1-webmcp/04-execution/CargoMesh_Team_Execution_Checklist.md
...
1. Lee README.md.
2. Lee docs/v1-webmcp/00-master/ADR-001_Dynamic_Provider_Registry.md.
3. Lee docs/v1-webmcp/04-execution/CargoMesh_Team_Execution_Checklist.md.
